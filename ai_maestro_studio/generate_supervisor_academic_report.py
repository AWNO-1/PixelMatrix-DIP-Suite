...
<div class="cover-container">
  ...
  <div class="cover-meta">
    <div class="cover-team">
      ...
      <p>• <strong>أواب النزيلي (Awwab Al-Nuzaili)</strong> — رئيس الفريق ومهندس الرؤية والحركات (Lead CV & Pose Architect)</p>
      <p>• <strong>محمد العواضي (Mohammed Al-Awadhi)</strong> — مهندس النظم الصوتية ومعالجة الإشارات (Audio Synthesis & DSP Lead)</p>
      <p>• <strong>مشعل حاجب (Mishaal Hajeb)</strong> — مهندس واجهات التحكم بدون لمس والبيومتركس (Touchless HUD & Biometrics Lead)</p>
    </div>
