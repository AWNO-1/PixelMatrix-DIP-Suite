  ...
  <div class="cover-meta-wrapper">
    ...
    <div class="cover-team-grid">
      <div class="member-card">
        ...
        <p class="member-desc">مهندس الرؤية الحاسوبية وتتبع وضعيات الجسم واليدين</p>
      </div>
      ...
      <div class="member-card">
        ...
        <p class="member-desc">مهندس معالجة الإشارات الصوتية ومحركات التوليف الترددي</p>
      </div>
      ...
      <div class="member-card">
        ...
        <p class="member-desc">مهندس الواجهات بدون لمس والتحليل البيوميتري والمؤثرات</p>
      </div>
    </div>
  </div>
