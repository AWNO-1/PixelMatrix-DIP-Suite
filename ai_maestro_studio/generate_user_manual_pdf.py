  ...
  <div class="cover-meta-wrapper">
    ...
    <div class="cover-team-grid">
      <div class="member-card">
        <span class="member-role-badge badge-architect" dir="ltr">TEAM LEADER & LEAD ARCHITECT</span>
        <div class="member-name-ar">أواب النزيلي</div>
        <div class="member-name-en" dir="ltr">Awwab Al-Nuzaili</div>
        <p class="member-desc">رئيس الفريق ومطور محرك المايسترو وتتبع وضعيات الجسم والآلات الافتراضية</p>
      </div>

      <div class="member-card">
        <span class="member-role-badge badge-dsp" dir="ltr">DSP SPECIALIST</span>
        <div class="member-name-ar">محمد العواضي</div>
        <div class="member-name-en" dir="ltr">Mohammed Al-Awadhi</div>
        <p class="member-desc">مهندس النظم والمساعدة في إدارة بنك الأصوات ومحرك FluidSynth</p>
      </div>

      <div class="member-card">
        <span class="member-role-badge badge-hud" dir="ltr">UI/UX ASSISTANT</span>
        <div class="member-name-ar">مشعل حاجب</div>
        <div class="member-name-en" dir="ltr">Mishaal Hajeb</div>
        <p class="member-desc">مهندس الواجهات وتجربة الاستخدام والمساعدة في المؤثرات البصرية</p>
      </div>
    </div>
  </div>
