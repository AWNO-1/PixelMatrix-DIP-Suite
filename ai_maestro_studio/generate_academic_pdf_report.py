...
<div class="cover-container">
  ...
  <div class="cover-meta-wrapper">
    ...
    <div class="cover-supervisor-card">
      ...
      <div class="sup-desc">توثيق استيفاء معايير التقييم الستة للحصول على الدرجة الكاملة (Full Mark Rubric Evaluation)</div>
    </div>
    ...
    <div class="cover-team-grid">
      <div class="member-card">
        ...
        <p class="member-desc">هندسة الرؤية الحاسوبية ومعالجة الصور ونماذج التعلم العميق</p>
      </div>
      ...
      <div class="member-card">
        ...
        <p class="member-desc">هندسة النظم ومعالجة الإشارات الرقمية وتوليف الموجات الترددية</p>
      </div>
      ...
      <div class="member-card">
        ...
        <p class="member-desc">هندسة واجهات التفاعل البيومترية وخوارزميات التتبع الحركي</p>
      </div>
    </div>
  </div>
