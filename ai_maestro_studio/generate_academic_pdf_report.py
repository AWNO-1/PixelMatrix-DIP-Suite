...
<div class="cover-container">
  ...
  <div class="cover-meta">
    <div class="cover-team">
      ...
      <p>• <strong>أواب النزيلي (Awwab Al-Nuzaili)</strong> — Team Leader & Lead Architect: Pose Engine, Virtual Conductor & Instruments</p>
      <p>• <strong>محمد العواضي (Mohammed Al-Awadhi)</strong> — DSP Specialist: Audio Synthesizer & SoundFont Curation</p>
      <p>• <strong>مشعل حاجب (Mishaal Hajeb)</strong> — UI/UX Assistant: HUD Display & Biometric Visuals</p>
    </div>
